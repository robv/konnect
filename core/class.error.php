<?PHP
    class Error
    {
        ...
        private function __construct($class = "validation",$style = "border:1px solid red;")
        {
			$this->class = $class;
            $this->errors = array();
            $this->style = $style;
        ...
        public function ul($class = 'warn')
        {
            ...
            $out = $this->css().'<ul class='.$this->class.'>';
        ...
        public function email($val, $id = 'email', $name = null)
        {
            if(!eregi("^([_a-z0-9+-]+)(\.[_a-z0-9-]+)*@([a-z0-9-]+)(\.[a-z0-9-]+)*(\.[a-z]{2,4})$", $val))
            {
                $this->add($id, $name.' is not a valid email address.');
                return false;
            }
        ...
        public function date($val, $id, $name = null)
        {
            if(strtotime($val) === false)
            {
                $this->add($id, $name.' is not a valid date');
                return false;
            }
        ...
        public function phone($val, $id, $name = null)
        {
            $val = preg_replace('/[^0-9]/', '', $val);
            if(strlen($val) != 7 && strlen($val) != 10)
            {
                $this->add($id, $name.' is not a valid 7 or 10 digit phone number.');
                return false;
            }
